...
export const POINTS_DATA = [
  ...
  },
  {
    ...
    imgdesc: [<span>Дорога в хозяйственный двор. 2018 г.</span>],
    filter: 1,
  },
  {
  ...
  },
  {
    ...
    info: (
      <>
        ...
        "возвышение, покрытое коврами и подушками". До 1976 года скамья располагалась в пейзажной
        части сада, за прудом, на «мокром лугу» недалеко от «лукоморского» дуба с видом на восток.
      </>
    ),
    img: [map15],
    imgdesc: [
  ...
  },
  {
    ...
    imgdesc: [
      <span></span>,
      <span>
        Дуб "У Лукоморья". Фотография из семейного архива М. Свириденко. Конец 1950 - начало 1960
        годов
      </span>,
    ],
    filter: 4,
  },
  {
    ...
    info: (
      <>
        ...
        культуры, кинотеатр, жилой дом, изба-читальня, чайный домик.В 1986 году на I Областном
        Пушкинском празднике в этом здании был открыт первый общественный музей в Суйде,
        проработавший до 1993 года.
      </>
    ),
    img: [map22, map22_2],
    imgdesc: [<span>Современный вид на западный приусадебный двор. 2018 г.</span>],
    filter: 3,
  },
  {
    name: 'Дом егеря',
  ...
  },
  {
    ...
    img: [map28],
    imgdesc: [<span>Солнечные часы в Суйде. Фотография из архива музея-усадьбы "Суйда"</span>],
    filter: 0,
  },
  {
  ...
  },
  {
    ...
    info: (
      <>
        ...
        Родионовны. (утрачена в 1990). (Фотография из архива музея-усадьбы "Суйда" 1959, 2010-е).
      </>
    ),
    img: [map35_2, map35_1],
    imgdesc: [
      <span>Памятник Арине Родионовне</span>,
  ...
  },
  {
    ...
    info: (
      <>
        Церковь поставлена в 1992 году в память об трех утраченных церквях Воскресения Христова в
  ...
  },
  {
    ...
    img: [map37_1, map37_2],
    imgdesc: [
      <span>Современный вид 2024 г. Лузанов В.М.</span>,
      <span>
        Венчание будущих родителей А.С. Пушкина в Суйдинской церкви. 1989. Музей-усадьба "Суйда"
      </span>,
    ],
    filter: 2,
  },
