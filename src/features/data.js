...
export const ROOMS_DATA = [
  {
    ...
    quiz: QUIZ_DATA_1,
    quizTexts : {
      startPage: <>А вы знаете, где находитесь? Предлагаем несколько вариантов… < br/> Начните викторину.</>,
      endPageGood: 'Вы хорошо ориентируетесь на территории усадьбы, можете отличить «гостевой флигель» от «людской», знаете сколько имений было у Ганнибала. ',
      endPageBad: 'Возможно, вам стоит прогуляться по усадьбе, еще раз изучить отличия «инженера-конструктора» от «инженера-фортификатор». Попробуйте пройти викторину снова.'
    }
  },
  {
    name: 'Зал 2',
    ...
    quiz: QUIZ_DATA_1,
    quizTexts : {
      startPage: <>А вы знаете, где находитесь? Предлагаем несколько вариантов…Начните викторину.</>,
      endPageGood: 'Вы хорошо ориентируетесь на территории усадьбы, можете отличить «гостевой флигель» от «людской», знаете сколько имений было у Ганнибала. ',
      endPageBad: 'Возможно, вам стоит прогуляться по усадьбе, еще раз изучить отличия «инженера-конструктора» от «инженера-фортификатор». Попробуйте пройти викторину снова.'
    }
  },
