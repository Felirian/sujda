...
export const MAP_POINTS = [
  ...
  {
    name: 'точка 2',
    info: 'И в годы ссылки Пушкина в Михайловское она рядом с ним и глубокое уважение к нянепростой деревенской женщине, сквозит в словах поэта: «вы, кажется, раз ее видели: она –единственная моя подруга…. Все товарищи, друзья и добрые знакомые поэта знали ее илислышали о ней и любили ее. Последний год жизни Арина Родионовна провела в доме сестры поэта,Ольги Сергеевныурожденной Пушкиной) в Петербурге где 31 июля 1828 годаскончалась. Смерть ее опечалила не только семью Пушкиных и Александра Сергеевича но и егодрузей «Если грядущее поколение будет чтить мое имядолжна быть не забыта и эта беднаястарушка» Пушкин А.С',
    img: Person2,
    top: 210,
    left: 210,
  },
